                        ...
                        <form method="post" action="{{ route('address.update', $address) }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-textarea class="mt-1 block w-full"
                                            id="detail"
                                            name="detail"
                                            placeholder="Tuliskan alamat secara lengkap dimulai dari nama jalan, nomer rumah, RT/RW, Nama Desa, Kecamatan, Kabupaten, dan Provinsi">{{ old('detail', $address->detail) }}</x-textarea>
