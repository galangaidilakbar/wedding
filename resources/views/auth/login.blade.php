<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('translations.email')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('translations.password')" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('translations.Remember me') }}</span>
            </label>
        </div>
