            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('is-admin')
                        ...
                        <x-nav-link :href="route('admin.order.reports.create')"
                                    :active="request()->routeIs('admin.order.reports.create')">
                            {{ __('Laporan') }}
                        </x-nav-link>
                    @endcan
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('is-admin')
                ...
                <x-responsive-nav-link :href="route('admin.order.reports.create')"
                                       :active="request()->routeIs('admin.order.reports.create')">
                    {{ __('Laporan') }}
                </x-responsive-nav-link>
            @endcan
